...
\sepspace
\education{Diplôme de Technicien ES en Informatique}{Août 2019--Juin 2021}{Centre de formation professionnelle Technique}{Compétences acquises : API REST, Python, C, HTML5, CSS, PHP, C\#, SQL, Modélisation UML, JavaScript, POO, Git, LaTeX, Développement de logiciels, Tests unitaires.}
\sepspace
