...
\work{Assistant HES}{Janv. 2024--Auj.}{HEG-Genève}{Assistance à l'enseignement : cours Bachelor en statistiques et cours Master en sciences décisionnelles
    \newline Projets de recherches : optimisation combinatoires, analyse de données, représentations spatiales, etc.
    \newline Gestion de serveurs de développement.
    \newline Organisation d'une conférence.}
